...
```{r}
library(plyr)
Sub_1 <-match_df(Spatial_Data_Alternate, Mackerel_Probability_Occurrance, on = c("Latitude", "Longitude"))
Sub_2 <-match_df(Mackerel_Probability_Occurrance, Spatial_Data_Alternate, on = c("Latitude", "Longitude"))
...
We see that over 50 years, the Mackerel population is barely moving at all. We know this is not accurate because studies show that fish populations are already moving. (reference)