...
```{r}
library(plyr)
Sub_B_1 <-match_df(Spatial_Data_Best, Herring_Probability_Occurrance, on = c("Latitude", "Longitude"))
Sub_B_2 <-match_df(Herring_Probability_Occurrance, Spatial_Data_Worst, on = c("Latitude", "Longitude"))
...
We see that by 2080, the probability occurrance is low for most areas,probably too low an amount to support a fishing business.
